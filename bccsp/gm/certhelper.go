...
//create sm2 certificate by sm2 interface
...
//create sm2 certificate request by sm2 interface
...
// parse x509 certificate request to sm2 certificate request
...
// parse x509 certificate to sm2 certificate( just same struct but defined in different package)
...
//parse sm2 certificate to x509 certificate
